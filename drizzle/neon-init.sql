...
ALTER TABLE "clicks" ADD CONSTRAINT "clicks_merchant_id_merchants_id_fk" FOREIGN KEY ("merchant_id") REFERENCES "public"."merchants"("id") ON DELETE cascade ON UPDATE no action;
ALTER TABLE "merchants" ADD CONSTRAINT "merchants_network_id_networks_id_fk" FOREIGN KEY ("network_id") REFERENCES "public"."networks"("id") ON DELETE cascade ON UPDATE no action;
...
ALTER TABLE "wallet_transactions" ADD CONSTRAINT "wallet_transactions_admin_user_id_users_id_fk" FOREIGN KEY ("admin_user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;
...
ALTER TABLE "withdrawal_requests" ADD CONSTRAINT "withdrawal_requests_processed_by_admin_id_users_id_fk" FOREIGN KEY ("processed_by_admin_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;
CREATE INDEX "clicks_user_id_idx" ON "clicks" USING btree ("user_id");
CREATE INDEX "clicks_merchant_id_idx" ON "clicks" USING btree ("merchant_id");
CREATE INDEX "clicks_created_at_idx" ON "clicks" USING btree ("created_at");
CREATE INDEX "merchants_network_id_idx" ON "merchants" USING btree ("network_id");
...
CREATE INDEX "wallet_transactions_admin_user_id_idx" ON "wallet_transactions" USING btree ("admin_user_id");
