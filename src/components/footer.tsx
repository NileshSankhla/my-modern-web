...
gap-4 border-t border-border/40 pt-8 sm:flex-row">

          {/* Amazon Associate Disclosure */}
          <p className="w-full text-center text-xs text-muted-foreground 
  border-b border-border/40 pb-4 mb-2">
            As an Amazon Associate, Fareback earns from qualifying purchases.
            Cashback is provided by Fareback and not by Amazon.
          </p>
